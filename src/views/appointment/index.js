  ...
  return (
    <>
      <CModal visible={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <CModalHeader>
          <CModalTitle>Salvar agendamento </CModalTitle>
        </CModalHeader>
        <CModalBody>
          <SaveAppointmentForm />
        </CModalBody>
            ...
            <CTable align="middle" className="mb-0 border" hover responsive>
              <CTableHead color="light">
                <CTableRow>
                  ...
                  <CTableHeaderCell className="text-center">Data do Agendamento</CTableHeaderCell>
                  <CTableHeaderCell>Tratamento</CTableHeaderCell>
              ...
              <CTableBody>
                {agendamentos.map(
                  (
                    { id, user, dataAgendamento, treatmentSalon, statusReservation, createdAt },
                    idx,
                  ) => (
                    <CTableRow v-for="item in tableItems" key={id}>
                      ...
                      <CTableDataCell className="text-center">{dataAgendamento}</CTableDataCell>
                      <CTableDataCell>{treatmentSalon?.treatment?.name}</CTableDataCell>
                      <CTableDataCell className="text-center">
                        <div className="clearfix">
                          <small className="text-medium-emphasis">
                            {statusReservation?.description}
                          </small>
                        </div>
